...
| Plugin | Purpose |
|--------|---------|
| `Codex-setup` | Environment and project setup management |
| `Codex-md-management` | Markdown file handling and organization |
...
**Project skills** (`.Codex/skills` and `.Codex/agents`):
